...
public class MainBBS {
    ...
    public static void main(String[] args){
        ...
        OctetString proof = ProofGen.ProofGen(publicKey, signature, header, ph, messages, disclosed_indexes);
        System.out.println("Proof:   " + proof.toString());
        boolean proofValid = ProofVerify.ProofVerify(publicKey, proof, header, ph, messages, disclosed_indexes);
