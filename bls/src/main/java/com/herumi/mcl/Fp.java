...
public class Fp {
  ...
  public Fp(String str, int radix) {
    this(MclJNI.new_Fp__SWIG_3(str, radix), true);
  }
  ...
  public void setStr(String str, int radix) {
    MclJNI.Fp_setStr__SWIG_0(swigCPtr, this, str, radix);
  }
  ...
  public String toString(int radix) {
    return MclJNI.Fp_toString__SWIG_0(swigCPtr, this, radix);
  }
