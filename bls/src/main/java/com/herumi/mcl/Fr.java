...
public class Fr {
  ...
  public Fr(String str, int radix) {
    this(MclJNI.new_Fr__SWIG_3(str, radix), true);
  }
  ...
  public void setStr(String str, int radix) {
    MclJNI.Fr_setStr__SWIG_0(swigCPtr, this, str, radix);
  }
  ...
  public String toString(int radix) {
    return MclJNI.Fr_toString__SWIG_0(swigCPtr, this, radix);
  }
